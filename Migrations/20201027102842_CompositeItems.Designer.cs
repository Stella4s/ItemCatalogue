...
namespace ItemCatalogue.Migrations
{
    ...
    [Migration("20201027102842_CompositeItems")]
    partial class CompositeItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemCatalogue.Models.CompositeItem", b =>
                {
            ...
            modelBuilder.Entity("ItemCatalogue.Models.CompositeItem", b =>
                {
                    b.HasOne("ItemCatalogue.Models.BaseItem", "ChildItem")
                        .WithMany()
                        .HasForeignKey("ChildItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ItemCatalogue.Models.BaseItem", "ParentItem")
                        .WithMany("CompositeItems")
